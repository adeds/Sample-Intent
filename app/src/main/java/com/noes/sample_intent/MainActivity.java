    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSub1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent_bawa = new Intent(MainActivity.this, Sub1Activity.class);
                startActivity(intent_bawa);
            }
        });
        ...
        btnSub2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent_bawa = new Intent(MainActivity.this, Sub2Activity.class);
                intent_bawa.putExtra(Sub2Activity.KEY_a, strIntent);
                startActivityForResult(intent_bawa, 0);
            }
        });
        ...
        btnDial.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent_bawa = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:085701499669"));
                startActivity(intent_bawa);
            }
        });
    }
